...
public class FirstIntersection {
	public static void main(String[] args) {
		...
		PO3.SetName("PO3");
		PO3.Value = new TransferOperation("localhost", "2000", "p5");
		...
		// grdt9.Activations.add(new Activation(t9, "P_a3",
		// TransitionOperation.Move,"P_a3"));
		...
		t14.InputPlaceName.add("P_o3Exit");

		Condition t14Ct1 = new Condition(t14,"P_o3Exit", TransitionCondition.NotNull);

		GuardMapping grdt14 = new GuardMapping();
		grdt14.condition = t14Ct1;
		grdt14.Activations.add(new Activation(t14,"P_o3Exit",TransitionOperation.SendOverNetwork,"PO3"));
